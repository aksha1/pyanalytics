...
r_sq #coeff of determination : > .6 is good # 71% variation in y is explained by x
model.intercept_  #bo #y value when x=0, or y intercept
model.coef_  #b1 #for 1 unit of increase in x y changes .54 times
