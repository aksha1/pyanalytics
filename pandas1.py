...
#pip install pydataset #install library if it doesnt exist
from pydataset import data #import module data from pydataset
mtcars = data('mtcars') #load mtcars dataset into variable
mtcarsDF = mtcars #loading to new dataframe

mtcarsDF #printing dataframe
type(mtcarsDF) #type of datastructure
